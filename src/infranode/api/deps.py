...
Waechst spaeter (Cache-Helper, Rate-Limit-Kontext, ResilientSourceClient).
"""
...
def get_resilient_client(request: Request):
    ...
    ein in Request A geoeffneter Breaker bleibt in Request B offen (RES-04). Die
    Fassade ist die EINE Einstiegsfunktion fuer alle Quellen-Adapter ab Phase 4.
    """
