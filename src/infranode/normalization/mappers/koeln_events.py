"""Reiner Koeln-Events-Mapper map_koeln_events (DATA-16, D-06, Tier A DL-DE/Zero).
...
Koeln" auf offenedaten-koeln.de, govdata.de/dl-de/zero-2-0; Koeln stellt seit
Mitte 2022 standardmaessig unter DL-DE/Zero bereit). Statt das Tier hartzukodieren
...
def map_koeln_events(
    ...
    *,
    ...
    ``(DL_DE_ZERO_2_0, A)``. Die ``events`` wandern unveraendert in den
