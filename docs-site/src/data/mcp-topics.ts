...
export const mcpTopics: McpTopic[] = [
  ...
  },
  {
    ...
    de: {
      ...
      what: "Das MCP-Tool air_quality liefert die Messwerte der nächstgelegenen UBA-Station: Feinstaub PM10 und PM2.5, Stickstoffdioxid NO2 und Ozon O3. Der KI-Agent ruft es auf, wenn du nach der Luftqualität einer Stadt fragst.",
      ...
      faq: [
        ...
        { q: "Welche Werte liefert das Tool?", a: "PM10, PM2.5, NO2 und O3 aus dem Messnetz des Umweltbundesamts, mit Messzeitpunkt und Stationsbezug." },
      ],
    },
    en: {
      slug: "air-quality",
      ...
      what: "The air_quality MCP tool returns readings from the nearest UBA station: PM10 and PM2.5, NO2 and O3. The AI agent calls it when you ask about a city's air quality.",
      ...
      faq: [
        ...
        { q: "Which values does the tool return?", a: "PM10, PM2.5, NO2 and O3 from the German Environment Agency network, with measurement time and station reference." },
      ],
    },
  },
  {
