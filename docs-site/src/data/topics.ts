...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    de: {
      ...
      dataDesc:
        "Pro Stadt liefert der Endpunkt die Messwerte der nächstgelegenen UBA-Station: Feinstaub PM10 und PM2.5, Stickstoffdioxid NO2 und Ozon O3, jeweils mit Messzeitpunkt und Stationsbezug.",
      sourceName: "Umweltbundesamt (UBA)",
      sourceUrl: "https://www.umweltbundesamt.de/",
      license: "DL-DE BY 2.0",
      licenseUrl: "https://www.govdata.de/dl-de/by-2-0",
      vars: ["Feinstaub PM10", "Feinstaub PM2.5", "Stickstoffdioxid (NO2)", "Ozon (O3)", "Messzeitpunkt", "Messstation"],
      ...
      faq: [
        ...
        { q: "Welche Schadstoffe sind enthalten?", a: "Feinstaub PM10 und PM2.5, Stickstoffdioxid NO2 und Ozon O3 aus dem Messnetz des Umweltbundesamts, mit Messzeitpunkt und Stationsbezug je Wert." },
      ...
      datasetDesc: "Aktuelle Luftqualitätswerte (PM10, PM2.5, NO2, O3) für deutsche Großstädte aus dem Messnetz des Umweltbundesamts, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      ...
      dataDesc:
        "For each city the endpoint returns readings from the nearest UBA station: particulate matter PM10 and PM2.5, nitrogen dioxide NO2 and ozone O3, each with measurement time and station reference.",
      sourceName: "German Environment Agency (UBA)",
      sourceUrl: "https://www.umweltbundesamt.de/en",
      license: "DL-DE BY 2.0",
      licenseUrl: "https://www.govdata.de/dl-de/by-2-0",
      vars: ["Particulate matter PM10", "Particulate matter PM2.5", "Nitrogen dioxide (NO2)", "Ozone (O3)", "Measurement time", "Monitoring station"],
      ...
      faq: [
        ...
        { q: "Which pollutants are included?", a: "Particulate matter PM10 and PM2.5, nitrogen dioxide NO2 and ozone O3 from the German Environment Agency network, with measurement time and station reference per value." },
      ...
      datasetDesc: "Current air quality values (PM10, PM2.5, NO2, O3) for major German cities from the German Environment Agency network, free and keyless via a JSON REST API.",
    },
  },
  {
  ...
  },
  {
    ...
    de: {
      ...
      metaTitle: "Solarkataster-API NRW (Dach-PV): Potenzial je Stadt, keylos",
      h1: "Solarkataster-API für Städte in NRW (Dach-PV)",
      lead: "Das Dach-Photovoltaik-Potenzial je Stadt über eine kostenlose, keylose REST-API. Quelle ist das amtliche Solarkataster NRW (LANUK, Geobasis NRW, MaStR), aggregiert je Gemeinde und einheitlich als JSON mit Quelle, Lizenz und Stichtag je Antwort.",
      dataDesc:
        "Pro abgedeckter Stadt liefert der Endpunkt das gesamte installierbare Dach-PV-Potenzial (Leistung in kWp und Jahresertrag in MWh), den bereits installierten Bestand, den Ausschöpfungsgrad in Prozent sowie die Aufschlüsselung des Potenzials nach Gebäudekategorie (Wohngebäude, Gewerbe und Industrie, öffentliche Gebäude, Landwirtschaft, Sonstige). Anders als die Solar-API (Einstrahlung und Ertrag je kWp aus PVGIS) liefert diese Schnittstelle die Mengen je Stadt.",
      sourceName: "Solarkataster NRW (LANUK, Geobasis NRW, MaStR)",
      sourceUrl: "https://www.opengeodata.nrw.de/produkte/umwelt_klima/energie/solarkataster/",
      license: "DL-DE Zero 2.0",
      licenseUrl: "https://www.govdata.de/dl-de/zero-2-0",
      vars: ["Installierbares Potenzial (kWp)", "Potenzieller Jahresertrag (MWh)", "Installierter Bestand (kWp)", "Bestands-Jahresertrag (MWh)", "Ausschöpfungsgrad (%)", "Potenzial je Gebäudekategorie", "Stichtag"],
      keywords: ["Solarkataster API", "Dach-PV Potenzial API", "Solarpotenzial NRW API", "Photovoltaik Dachflächen API", "PV Potenzial Stadt API", "Solarkataster NRW Daten"],
      coverageNote: "Das Dach-Solarkataster ist pro Bundesland föderiert. Aktuell abgedeckt sind die Städte in Nordrhein-Westfalen (NRW-Pilot); weitere Länder folgen, sobald ihr offenes Gemeinde-Aggregat vorliegt.",
      faq: [
        ...
        { q: "Warum nur NRW?", a: "Dach-Solarkataster werden je Bundesland erhoben. NRW stellt ein offenes Gemeinde-Aggregat unter DL-DE Zero 2.0 bereit, das sich sauber je Stadt ausliefern lässt. Für Städte ohne abgedecktes Land antwortet die API ehrlich mit not_covered statt zu raten." },
      ],
      datasetName: "InfraNode Dach-Solarkataster NRW (Potenzial je Stadt)",
      datasetDesc: "Installierbares und installiertes Dach-PV-Potenzial (kWp, MWh, Ausschöpfungsgrad, je Gebäudekategorie) je Stadt aus dem amtlichen Solarkataster NRW, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      slug: "solar-cadastre-api",
      metaTitle: "Solar Cadastre API NRW (rooftop PV): potential per city, keyless",
      h1: "Solar cadastre API for cities in NRW (rooftop PV)",
      lead: "Rooftop photovoltaic potential per city through a free, keyless REST API. The source is the official solar cadastre of North Rhine-Westphalia (LANUK, Geobasis NRW, MaStR), aggregated per municipality and delivered as consistent JSON with source, license and reference date on every response.",
      dataDesc:
        "For each covered city the endpoint returns the total installable rooftop PV potential (capacity in kWp and annual yield in MWh), the already installed stock, the exploitation ratio in percent and the potential broken down per building category (residential, commercial and industry, public, agriculture, other). Unlike the solar API (irradiation and yield per kWp from PVGIS), this interface returns the per-city quantities.",
      sourceName: "Solar cadastre NRW (LANUK, Geobasis NRW, MaStR)",
      sourceUrl: "https://www.opengeodata.nrw.de/produkte/umwelt_klima/energie/solarkataster/",
      license: "DL-DE Zero 2.0",
      licenseUrl: "https://www.govdata.de/dl-de/zero-2-0",
      vars: ["Installable potential (kWp)", "Potential annual yield (MWh)", "Installed stock (kWp)", "Installed annual yield (MWh)", "Exploitation ratio (%)", "Potential per building category", "Reference date"],
      keywords: ["solar cadastre API", "rooftop PV potential API", "solar potential NRW API", "photovoltaic rooftop API", "PV potential city API", "Solarkataster NRW data"],
      coverageNote: "The rooftop solar cadastre is federated per federal state. Currently covered are the cities in North Rhine-Westphalia (NRW pilot); more states follow once their open municipal aggregate is available.",
      faq: [
        ...
        { q: "Why only NRW?", a: "Rooftop solar cadastres are compiled per federal state. NRW provides an open municipal aggregate under DL-DE Zero 2.0 that serves cleanly per city. For cities without a covered state the API answers honestly with not_covered instead of guessing." },
      ],
      datasetName: "InfraNode rooftop solar cadastre NRW (potential per city)",
      datasetDesc: "Installable and installed rooftop PV potential (kWp, MWh, exploitation ratio, per building category) per city from the official NRW solar cadastre, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "public-transport",
