...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    de: {
      ...
      metaTitle: "Solarkataster-API (Dach-PV): Potenzial je Stadt, keylos (NRW, Bayern)",
      h1: "Solarkataster-API für deutsche Städte (Dach-PV)",
      lead: "Das Dach-Photovoltaik-Potenzial je Stadt über eine kostenlose, keylose REST-API. Quelle sind die amtlichen Solarkataster der Länder (NRW: LANUK/Geobasis NRW/MaStR; Bayern: Bayerisches Landesamt für Umwelt), je Gemeinde aggregiert und einheitlich als JSON mit Quelle und Lizenz je Antwort.",
      dataDesc:
        "Pro abgedeckter Stadt liefert der Endpunkt das gesamte installierbare Dach-PV-Potenzial (Leistung in kWp und Jahresertrag in MWh), den bereits installierten Bestand und den Ausschöpfungsgrad in Prozent; für NRW zusätzlich die Aufschlüsselung des Potenzials nach Gebäudekategorie. Anders als die Solar-API (Einstrahlung und Ertrag je kWp aus PVGIS) liefert diese Schnittstelle die Mengen je Stadt.",
      sourceName: "Solarkataster der Länder (NRW: LANUK/Geobasis NRW; Bayern: LfU)",
      sourceUrl: "https://www.opengeodata.nrw.de/produkte/umwelt_klima/energie/solarkataster/",
      license: "DL-DE Zero 2.0 (NRW), CC BY 4.0 (Bayern)",
      licenseUrl: "https://www.govdata.de/dl-de/zero-2-0",
      ...
      keywords: ["Solarkataster API", "Dach-PV Potenzial API", "Solarpotenzial API Deutschland", "Photovoltaik Dachflächen API", "PV Potenzial Stadt API", "Solarkataster NRW Bayern Daten"],
      coverageNote: "Das Dach-Solarkataster ist pro Bundesland föderiert. Aktuell abgedeckt sind die Städte in Nordrhein-Westfalen und Bayern; weitere Länder folgen, sobald ihr offenes Gemeinde-Aggregat vorliegt.",
      faq: [
        ...
        { q: "Welche Länder sind abgedeckt?", a: "Aktuell Nordrhein-Westfalen (Solarkataster NRW, DL-DE Zero 2.0) und Bayern (Energie-Atlas Bayern, CC BY 4.0). Dach-Solarkataster werden je Bundesland erhoben; weitere Länder kommen hinzu, sobald ein offenes Gemeinde-Aggregat vorliegt. Für Städte ohne abgedecktes Land antwortet die API ehrlich mit not_covered statt zu raten." },
      ],
      datasetName: "InfraNode Dach-Solarkataster (Potenzial je Stadt, NRW + Bayern)",
      datasetDesc: "Installierbares und installiertes Dach-PV-Potenzial (kWp, MWh, Ausschöpfungsgrad) je Stadt aus den amtlichen Solarkatastern NRW und Bayern, kostenlos und keylos über eine REST-API als JSON.",
    },
    en: {
      slug: "solar-cadastre-api",
      metaTitle: "Solar Cadastre API (rooftop PV): potential per city, keyless (NRW, Bavaria)",
      h1: "Solar cadastre API for German cities (rooftop PV)",
      lead: "Rooftop photovoltaic potential per city through a free, keyless REST API. The sources are the official state solar cadastres (NRW: LANUK/Geobasis NRW/MaStR; Bavaria: Bavarian Environment Agency), aggregated per municipality and delivered as consistent JSON with source and license on every response.",
      dataDesc:
        "For each covered city the endpoint returns the total installable rooftop PV potential (capacity in kWp and annual yield in MWh), the already installed stock and the exploitation ratio in percent; for NRW also the potential broken down per building category. Unlike the solar API (irradiation and yield per kWp from PVGIS), this interface returns the per-city quantities.",
      sourceName: "State solar cadastres (NRW: LANUK/Geobasis NRW; Bavaria: LfU)",
      sourceUrl: "https://www.opengeodata.nrw.de/produkte/umwelt_klima/energie/solarkataster/",
      license: "DL-DE Zero 2.0 (NRW), CC BY 4.0 (Bavaria)",
      licenseUrl: "https://www.govdata.de/dl-de/zero-2-0",
      ...
      keywords: ["solar cadastre API", "rooftop PV potential API", "solar potential API Germany", "photovoltaic rooftop API", "PV potential city API", "Solarkataster NRW Bavaria data"],
      coverageNote: "The rooftop solar cadastre is federated per federal state. Currently covered are the cities in North Rhine-Westphalia and Bavaria; more states follow once their open municipal aggregate is available.",
      faq: [
        ...
        { q: "Which states are covered?", a: "Currently North Rhine-Westphalia (Solarkataster NRW, DL-DE Zero 2.0) and Bavaria (Energie-Atlas Bayern, CC BY 4.0). Rooftop solar cadastres are compiled per federal state; more states are added once an open municipal aggregate is available. For cities without a covered state the API answers honestly with not_covered instead of guessing." },
      ],
      datasetName: "InfraNode rooftop solar cadastre (potential per city, NRW + Bavaria)",
      datasetDesc: "Installable and installed rooftop PV potential (kWp, MWh, exploitation ratio) per city from the official NRW and Bavaria solar cadastres, free and keyless via a JSON REST API.",
    },
  },
  {
    id: "public-transport",
